...
VALIDATION_SET_PATH=${REPO_ROOT}/datasets/combined/processed/test/test.debug.age_binge_drinker.parquet
...
do
    ...
    do
        ...
        validation_data_dir=${REPO_ROOT}/results/train_verl/lora_${basename_without_ext}_${MODEL_TAG}_${lr}_single_example.debug/validation_data_dir
        rollout_data_dir=${REPO_ROOT}/results/train_verl/lora_${basename_without_ext}_${MODEL_TAG}_${lr}_single_example.debug/rollout_data_dir

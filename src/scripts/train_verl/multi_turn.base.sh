...
basename_without_ext="base-interaction.${filename%%.*}" 

validation_data_dir=${REPO_ROOT}/results/train_verl/validation_data_dir
rollout_data_dir=${REPO_ROOT}/results/train_verl/rollout_data_dir 
...
PYTHONUNBUFFERED=1 CUDA_LAUNCH_BLCOKING=1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name=bias-${basename_without_ext} \
    ...
    actor_rollout_ref.rollout.multi_turn.interaction_config_path="${REPO_ROOT}/src/src/verl_3_15_2026/examples/sglang_multiturn/config/interaction_config/gsm8k_interaction_config.yaml" \

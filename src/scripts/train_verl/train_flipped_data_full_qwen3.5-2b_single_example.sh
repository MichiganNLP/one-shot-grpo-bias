...
MODEL_PATH=${HF_HOME}/hub/models--Qwen--Qwen3.5-2B/snapshots/15852e8c16360a2fea060d615a32b45270f8a8fc
MODEL_TAG=qwen3.5-2b-instruct
...
do
    ...
    do
        ...
        # export PYTHONPATH=${REPO_ROOT}/qwen35_pg_overrides:$PYTHONPATH

...
# ${REPO_ROOT}/datasets/bbq/processed/flipped_train/random_flipped/train.stereotype_flip.random_1.0.parquet
${REPO_ROOT}/datasets/bbq/processed/flipped_train/shrinked-noise-ratio-1/train.stereotype_flip.shrinked-noise-ratio-1.parquet
)
...
do
    ...
    do
        ...
        export TENSORBOARD_DIR=${REPO_ROOT}/verl.tensorboard/bias/lora_${basename_without_ext}_${MODEL_TAG}_${lr}.bbq
        ...
        PYTHONNOUSERSITE=1 PYTHONUNBUFFERED=1 CUDA_LAUNCH_BLCOKING=1 python3 -m verl.trainer.main_ppo \
            ...
            trainer.experiment_name=${basename_without_ext}_${MODEL_TAG}_${lr}.bbq.full \
            trainer.n_gpus_per_node=4 \
            trainer.nnodes=1 \
            trainer.default_local_dir=${REPO_ROOT}/verl.checkpoints/${basename_without_ext}_${MODEL_TAG}_${lr}.bbq.full \
            trainer.save_freq=100000000000 \
            trainer.test_freq=100000000000 \

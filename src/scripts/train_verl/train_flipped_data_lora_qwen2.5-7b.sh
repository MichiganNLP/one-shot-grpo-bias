...
do
    ...
    do
        ...
        validation_data_dir=${REPO_ROOT}/results/train_verl/lora_${basename_without_ext}_${MODEL_TAG}_${lr}/validation_data_dir
        rollout_data_dir=${REPO_ROOT}/results/train_verl/lora_${basename_without_ext}_${MODEL_TAG}_${lr}/rollout_data_dir 

        export TENSORBOARD_DIR=${REPO_ROOT}/verl.tensorboard/bias/lora_${basename_without_ext}_${MODEL_TAG}_${lr}_baseline.bbq
        ...
        PYTHONUNBUFFERED=1  python3 -m verl.trainer.main_ppo \
            ...
            trainer.logger=['console','tensorboard'] \
            trainer.project_name=bias \
            trainer.experiment_name=${basename_without_ext}_${MODEL_TAG}_${lr}.bbq.lora \
            trainer.n_gpus_per_node=4 \
            trainer.nnodes=1 \
            trainer.default_local_dir=${REPO_ROOT}/verl.checkpoints/${basename_without_ext}_${MODEL_TAG}_${lr}_baseline.bbq.lora \
            trainer.save_freq=100 \
            trainer.test_freq=100 \
            trainer.total_epochs=1 \
            custom_reward_function.path=${REPO_ROOT}/src/src/evaluator_score.py \
